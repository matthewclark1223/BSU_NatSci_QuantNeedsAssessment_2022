...
#which programs are students in
...
#which programs are faculty's students in
...
##Same data as above but modified per Matt W's suggestions (i.e. non alluvial)
...
##alternative option to the alluvial diagram above per Mattw suggestion
